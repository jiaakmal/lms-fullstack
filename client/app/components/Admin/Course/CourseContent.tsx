...
//   if(item.title === '' || item.description === '' || item.links[0].title === '' || item.links[0].url === '' || item.videoUrl === '' ){
//     toast.error("Please fill all the fields");}
//     else{
//        let newVideoSection = "";
//        if(courseContentData.length > 0){
//         const lastVideoSection = courseContentData[courseContentData.length - 1].videoSection;
//         //use the last video section if available otherwise use user input 
//         if(lastVideoSection){
...
//                     <div></div>
//                   )}
//                   {/* arrow buton for Collapsed video courseContentData */}
...
//                         <p className="flex items-center text-xl dark:text-white text-black cursor-pointer "
...
//                 {/* add new content */}
//                 {
//                     index === setCourseContentData.length - 1 && (
//                         <div >
//                           <p className="flex items-center text-xl dark:text-white text-black cursor-pointer "
...
//         })}
//         <br/>
//         <div className="flex items-center text-xl dark:text-white text-black cursor-pointer"
